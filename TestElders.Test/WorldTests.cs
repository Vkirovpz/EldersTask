...
namespace TestElders.Test
{
    public class WorldTests
    {
        ...
        //{
        //    //Arrange
        //    var world = new World<Animal, Animal>(2, 1, RandomNumberGeneratorMock.ZeroChance);
        //    var animal = world.Animals.First();
        //    animal.Coupling (RandomNumberGeneratorMock.ZeroChance) ;
        //    animal.Eat(RandomNumberGeneratorMock.ZeroChance);
        //    bool a = true;
        //    //Act
        //    world.Cycle();
        //    //Assert
        //    Assert.Equal(a, animal.Coupling(RandomNumberGeneratorMock.ZeroChance));
